...
const events = [
  { type: 'receipt.verified', id: 'evt_8f2a…c19d', time: '12:44:08.291', tone: 'emerald' },
  { type: 'proof.generated', id: 'evt_8f2a…c0a7', time: '12:43:51.040', tone: 'blue' },
  { type: 'receipt.verified', id: 'evt_8f2a…bf88', time: '12:43:18.902', tone: 'emerald' },
  { type: 'score.updated', id: 'evt_8f2a…be21', time: '12:42:44.517', tone: 'amber' },
  { type: 'receipt.rejected', id: 'evt_8f2a…bd0c', time: '12:41:33.105', tone: 'red' },
]
    ...
    <main className="min-h-screen bg-[#0A0A0A] text-slate-300 selection:bg-emerald-400/20">
      <header className="flex h-16 items-center justify-between border-b border-white/[0.07] px-5 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold tracking-tight text-slate-100">LedgerLine<span className="text-emerald-400">/</span>registry</span>
          <span className="hidden border-l border-white/10 pl-3 text-xs text-slate-500 sm:block">Credit registry</span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4">
          <div className="hidden items-center gap-2 rounded-md border border-emerald-500/20 bg-emerald-500/[0.06] px-3 py-1.5 text-[11px] font-medium text-emerald-400 sm:flex"><span className="h-2 w-2 rounded-full bg-emerald-400" />LedgerLine operational</div>
          <button className="flex items-center gap-2 rounded-md border border-white/10 px-2.5 py-1.5 text-xs text-slate-300 hover:bg-white/[0.06]"><span className="flex h-5 w-5 items-center justify-center rounded-full bg-slate-700 text-[9px] font-bold text-slate-200">AC</span><span className="hidden sm:inline">LedgerLine</span><ChevronDown size={13} /></button>
        </div>
      </header>
